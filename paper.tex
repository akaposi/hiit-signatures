...
interpretation, and then refining it towards computing homomorphisms. For
...
$\blank^\M$ is very similar to the translation to displayed algebra sections,
which is discussed in Section \ref{sec:sections}. In essence, $\blank^\M$ is a
non-dependently typed version of the section translation. We will discuss in
more detail the interpretations of equalities and the other function types in
Section \ref{sec:sections}, and we leave the rest of the homomorphism
translation to Appendix \ref{sec:morphismrules}.
...
Contexts are interpreted as dependent relations between algebras and
...
\]
We present the implementation below. Here, we make $\hat{\gamma^D}$-s implicit
in addition to $\hat{\gamma}$-s, and mostly notate $\hat{\gamma^S}$ parameters
and applications,
...
\appendix
\section{The homomorphism interpretation}
