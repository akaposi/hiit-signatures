...
We do not include a $\lambda$ in the syntax. The reason is twofold; first,
...
In the presence of the univalence axiom, type constructor equations can be
always equivalently represented using usual path constructors, by adding
explicit equivalences to a signature. In this case, type constructor equations
serve as a shorthand for equivalences.
