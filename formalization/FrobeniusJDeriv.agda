...
{-
  Deriving a Frobenius variant of J from J. Previous discussion:

    https://groups.google.com/forum/#!searchin/homotopytypetheory/frobenius%7Csort:date/homotopytypetheory/b96TBt0Bn7Y/o5jOzzQ3AgAJ

  We (conceptually) only use strict J beta, but no functions, Σ-types or
  universes. This should be possible to rewrite with weak J computation as
  well. This sketch shows that a J rule does not get weaker if we don't have Σ,
  Π types and universes.

  Hence, the J in the theory of HIIT signatures is not made weaker by the absence
  of Π/Σ.
-}
